...
if (selectedTheme) {
    // If the validation is fulfilled, we ask what the isses was to know if we activated or deactivated the dark
...
themeButton.addEventListener('click', () => {
    ...
    // We save the theme and the current iscon that user chose
